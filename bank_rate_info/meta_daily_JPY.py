...
payload = {
        ...
        'autoDisabled:main:j_id30': 'AutoDisabled:Clicked',
        'submitTrigger': '',
        'autoDisabled:main:fileDownload': '',
        #'autoDisabled:main:j_id28': '',
        'autoDisabled:main:j_id31': 'AutoDisabled:Clicked',
...
for td in table_head_top.find_all('td',class_='head_td'): 
  if td.text != '\u3000\u3000\u3000\u3000\u3000':
...
for tbody  in soup_ptoken.find_all('tbody'):
  for tr in tbody.find_all('tr'): ## get tr content
    ...
    #for td in tr.find_all('td',class_='con_td'):  ## get td content
